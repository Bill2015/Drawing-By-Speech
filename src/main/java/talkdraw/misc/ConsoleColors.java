...
public class ConsoleColors {
    ...
    public static final String ACTION = "[" + PURPLE + "ACTION" + RESET + "] ";
    public static final String SUCCESS = "[" + GREEN + "SUCCESS" + RESET + "] ";
    public static final String WARNING = "[" + YELLOW + "WARNING" + RESET + "] ";
    public static final String STATUS = "[" + CYAN + "STATUS" + RESET + "] ";
    public static final String SEPERA_LINE = "\n" + INFO + "==================================================";
    public static final String SEPERA_LINE_ERROR = "\n" + ERROR + "==================================================";
