...
/**【指令】 《畫布相關指令》
    ...
    *  @param args_0 寬
    *  @param args_1 高 */
public class SetOutsideColorCommand extends Command{

    /** 建構子 */
    public SetOutsideColorCommand(App APP, CommandAttribute yamlLoader){
    ...
    public NextCommand execute( String ... args ) {
        ...
        switch ( phase ) {
            ...
            case Get_Color:
                try{
                    String msg=APP.TOOL_BAR.setOutsideColor(args[args.length-1]);
                    if( !msg.equals("true") ){
